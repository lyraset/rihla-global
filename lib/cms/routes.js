...
export const STATIC_ROUTES = [
  ...
  { path: '/services', label: 'Services', defaultTitle: `Our Services — ${SITE_NAME}` },
  ...
  { path: '/success', label: 'Success stories', defaultTitle: `Success Stories — ${SITE_NAME}` },
]
  ...
  return [
    { group: 'Main pages', routes: STATIC_ROUTES },
    {
      ...
      routes: countries
        ...
        .map((c) => ({
          path: `/countries/${String(c.code).toLowerCase()}`,
          label: c.name,
